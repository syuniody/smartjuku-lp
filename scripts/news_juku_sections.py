...
# ---------------------------------------------------------------------------
SECTIONS["elementary-ai-education-2030"] = dict(
    desc="2026年8月31日に示された次期学習指導要領の「審議まとめ（素案）」から、小学校のAI・情報教育を解説します。AIの特性・リスク・創作、授業での活用、授業時間の確保まで一次資料で整理しました。",
    ogd="小学校からAI教育へ。文科省の審議まとめ（素案）で示された学習内容、AI活用、授業時間の仕組みを一次資料で解説します。",
    lead="小学校からAI教育へ／何を学び、時間をどこから確保するのか",
    lede="「小学校からAI学習」という報道を見て、保護者から質問を受ける場面が増えそうです。ただし、今回示されたのは正式決定ではなく、次期学習指導要領に向けた審議まとめの素案です。塾が今すぐ教材を変える話ではありませんが、何を学ぶ構想なのか、授業でどこまで使うのかを正確に説明できるよう整理しました。",
    answer=[
...
# ---------------------------------------------------------------------------
SECTIONS["next-curriculum-guideline-2026"] = dict(
    desc="2026年8月31日に示された「次期学習指導要領等に向けた審議まとめ（素案）」を、時間割、評価、AI・情報教育、高校単位など7つのポイントで整理。正式決定ではない点と、塾が今から確認すべき実務を解説します。",
    ogd="次期学習指導要領で学校はどう変わるのか。文科省の審議まとめ（素案）を7つのポイントと塾への影響で解説します。",
    lead="時間割・通知表・AI・高校単位／学校を変える7つの提案",
    lede="学校が大きく変わるというニュースを見て、保護者から質問を受ける場面が増えそうです。今回の素案は、AIだけでなく、時間割、通知表、教科書、高校単位、入試との接続まで一つにつないだ文書です。塾が今すぐ教材を替える段階ではありませんが、何が提案され、何がまだ決まっていないかを分けて押さえておく必要があります。",
    answer=[
...
# ---------------------------------------------------------------------------
SECTIONS["high-school-tuition-public-private-shift"] = dict(
    desc="2026年度の高校1年生は全国でほぼ横ばいでしたが、公立は1万8,220人減り、私立は1万7,834人増えました。兵庫県の入試結果と合わせ、塾の進路指導で何を変えるべきかを整理します。",
    ogd="高校無償化初年度、高1は公立1万8,220人減・私立1万7,834人増。全国と兵庫県のデータから学校選びの変化を検証します。",
    lead="高1は公立1万8,220人減／私立1万7,834人増",
    lede="『公立第一志望、私立は滑り止め』を前提にした面談を続けてよいのか、見直す時期です。全国の高校1年生はほぼ横ばいなのに、公立は1万8,220人減り、私立は1万7,834人増えました。兵庫県の入試結果と合わせ、確認できる変化と、塾が進路指導で準備すべきことを整理します。",
    answer=[
...
# ---------------------------------------------------------------------------
SECTIONS["ena-34day-exam-camp"] = dict(
    desc="enaの34泊35日・約80万円の受験合宿を公式資料で検証。1日13時間の日程、清里・富士山の施設、安全管理、睡眠、効果データの限界と、親子が申込前に確認したい5項目を整理します。",
    ogd="enaの34泊35日・約80万円の受験合宿を検証。費用、日程、場所、安全管理、睡眠、効果と、参加前に親子で確認したい5項目を整理しました。",
    lead="34泊35日・255時間／問うべきは合宿後に子どもへ何が残るか",
    lede="中学受験を扱う塾なら、賛否を言う前に公式資料まで確認しておきたいテーマです。34泊35日、約80万円、1日13時間という数字だけでなく、生活場所、安全管理、睡眠、本人の意思、効果データの有無を分けて整理しました。保護者面談で確認したい5項目もまとめています。",
    answer=[
    ...
    hasshin=[
        "使えます。らっこキーワードでは『ena 合宿』に加え、『費用』『行かない』『何泊』『どこ』への検索が確認できました。地域の塾なら『合宿に行かない夏の学習計画』『受験合宿を選ぶ前の5項目』という実用記事に展開できます。",
        "刺激的な金額や日数だけを切り取らず、確認できた事実、公開資料では分からない点、自塾が用意できる代替案を分けて書くことが信頼につながります。",
    ],
)


# ---------------------------------------------------------------------------
SECTIONS["timee-juku-instructor"] = dict(
    desc="ITTO個別指導学院などのスポットワーク活用を公式事例で検証。講師不足、授業の連続性、生成AIとの役割分担、日本版DBSと、塾長が導入前に確認したい7項目を整理します。",
    ogd="塾講師までタイミー？ ITTOなどの公式事例から、個別指導塾の講師不足、授業品質、日本版DBSと導入前の7項目を解説します。",
    lead="30日分の枠が充足・13人勤務／問われるのは教室の学習設計",
    lede="個別指導塾の講師確保は、急な欠員がそのまま授業に響くほど厳しくなっています。スポットワークの利用を善悪だけで語らず、欠員補充と採用入口を分け、授業の連続性・安全・研修を教室としてどう担保するかを整理しました。",
    answer=[
...
# ---------------------------------------------------------------------------
SECTIONS["digital-textbook-content-standards"] = dict(
    desc="反復練習はデジタル教科書に載せられないのか。文科省の教科書検定見直し骨子案を一次資料で確認し、教科書に入るもの・補助教材へ分けるもの・未決定事項を整理します。",
    ogd="『反復練習は不適切』の本当の意味は？ 文科省の骨子案から、デジタル教科書と補助教材の線引きを一次資料で解説します。",
    lead="反復練習そのものを否定した案ではありません",
    lede="見出しだけでは、文科省が反復練習そのものを否定したように見えます。実際の骨子案が示すのは、全員が使う検定教科書と、大量演習・入試対策などの補助教材を分ける方向です。塾の指導と保護者説明にどう関わるかまで整理しました。",
    answer=[
...
# ---------------------------------------------------------------------------
SECTIONS["japan-dbs-cram-school"] = dict(
    desc="2026年12月25日施行の日本版DBSを、学習塾の認定制度、5つの基本要件、講師確認、採用・安全管理、施行前の準備に分けて解説します。",
    ogd="日本版DBSで学習塾はどうなる？学校との違い、認定の5要件、講師確認、採用・安全管理、塾長が施行前に行う準備を整理します。",
    lead="2026年12月25日施行／学習塾は一律義務ではなく認定制度",
    lede="日本版DBSは、すべての学習塾へ一律に犯罪事実確認を義務づける制度ではありません。認定を目指す塾は講師確認だけでなく、採用、研修、相談、初動対応、情報管理まで整える必要があります。認定要件と施行前の準備を、塾長向けに整理します。",
    answer=[
